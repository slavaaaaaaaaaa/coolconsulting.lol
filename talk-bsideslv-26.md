...
**Talk · BSides Las Vegas 2026** · Track: _I Am The Cavalry_  
With [Caleb Queern](https://www.linkedin.com/in/cqueern/)

[Watch on YouTube](https://www.youtube.com/live/6U_uXsKxVbs?t=704)
...
Mesh platforms like Meshtastic and MeshCore are often proposed as the fallback. We showed why they're the wrong shape for the job: emergency information dissemination is one-to-many, but mesh chat protocols are many-to-many. Flood routing saturates, node databases cap out, and every participant transmits — causing consumers of information to become trackable RF emitters.
...
We demoed the working system live — authored a boil-water notice, hit send, and watched receivers around the room light up — alongside head-to-head measurements against Meshtastic and MeshCore: airtime, carousel refresh, delivery time under load, and battery life.
